...
export const en = {
  ...
  tryIt: {
    ...
    regionLabel: "Region",
    workFormatLabel: "Work type",
    expLabel: "Experience",
    periodLabel: "Period",
    regions: ["Any region", "Moscow", "St. Petersburg", "Almaty"],
    workFormats: ["Any", "Remote", "Hybrid", "Office"],
    experiences: ["Any", "No experience", "1–3 years", "3–6 years", "6+ years"],
    periods: ["Last 7 days", "Last 14 days", "Last 30 days"],
    submit: "Simulate run",
    restart: "Run again",
  ...
  analyze: {
    pageTitle: "Run results",
    pageDescription:
      "Sample summary: top skills, frequent phrases, data quality, and deduplication.",
    badge: "Run results",
    backHome: "Back to home",
    pageHint: "Start a run below — the report is built from HH API data.",
    resultsEmptyTitle: "No results yet",
    resultsEmptyDescription:
      "Enter a query and click “Run analysis”. KPIs, top skills, phrases, and an Excel link will appear here.",
    history: {
      title: "Run history",
      empty: "No saved runs yet. Start your first — it will show up here.",
      loading: "Loading history…",
      loadingRun: "Loading run…",
      refresh: "Refresh",
      loadFailed: "Could not load history from the server.",
      listUnavailable:
        "Run list API is unavailable (restart the backend). Showing runs saved in this browser.",
      notReady: "Run is not finished yet or ended with an error.",
      noApiUrl: "API URL is not set (NEXT_PUBLIC_API_URL).",
      processed: "processed",
      status: {
        succeeded: "done",
        failed: "failed",
    ...
    launcher: {
      ...
      title: "Start a run",
      description:
        "Enter a query and parameters — the service collects vacancies via the HH API and returns a summary with an Excel report.",
      queryLabel: "query",
      queryPlaceholder: "e.g. Python Developer",
      regionLabel: "Region",
      regionSearchPlaceholder: "Find a region or city…",
      regionNoResults: "No results found",
      regionSearching: "Searching…",
      regionSearchError: "Could not load suggestions",
      regionPresets: [
        { id: "", label: "Any region" },
        { id: "1", label: "Moscow" },
        { id: "2", label: "Saint Petersburg" },
        { id: "160", label: "Almaty" },
      ],
      workFormatLabel: "Work type",
      workFormats: [
      ...
      experiences: [
        { id: "", label: "Any" },
        { id: "noExperience", label: "No experience" },
        { id: "between1And3", label: "1–3 years" },
        { id: "between3And6", label: "3–6 years" },
        { id: "moreThan6", label: "6+ years" },
      ],
      periodLabel: "Period",
      periods: [
      ...
      kwTopNLabel: "Keywords",
      kwMaxNgramLabel: "Max n-gram",
      submit: "Run analysis",
      running: "Running…",
      cancel: "Cancel",
      restart: "New run",
      ...
      progressPct: "Processed {done} of {total}",
      successWarn: "Done, but {n} vacancies failed to load",
      errors: {
        noApiUrl:
          "API URL is not set (NEXT_PUBLIC_API_URL). Add it to .env.local and restart the frontend.",
        noQuery: "Enter a search query.",
        tooManyVacancies:
          "Sample too large: found {search_count}, limit {max}. Reduce pages or narrow the query.",
        searchFailed: "HH search failed. Try again later or change the query.",
        exportFailed: "Could not build the report. Try again.",
        jobFailed: "Run finished with an error.",
        hhForbidden:
          "HH API rejected the request (403). HH_TOKEN is missing or expired on the API server — update the app token at dev.hh.ru and the HH_TOKEN variable.",
    ...
    statusFailed: "Failed",
    excel: "Excel",
    excelSoon: "Excel download — coming soon",
    kpi: {
      requested: "Requested",
      processed: "Processed",
      errors: "Errors",
    ...
    skillsTitle: "Top key skills",
    skillsHint: "% of mentions in sample",
    phrasesTitle: "Top phrases",
    phrasesHint: "% of mentions",
    coverageTitle: "Data quality",
    coverageCenter: "key_skills",
    coverageLegend: {
      withKeySkills: "With key_skills",
      noKeySkills: "Without key_skills",
    ...
    cloudTitle: "Skills cloud",
    cloudHint: "Size — mention frequency",
    errorsTitle: "Errors by reason",
    table: {
      skillsTitle: "Skills table",
      keywordsTitle: "Phrases table",
      rank: "#",
      name: "Name",
      count: "Count",
      share: "Share",
