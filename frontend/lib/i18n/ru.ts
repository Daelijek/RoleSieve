export const ru = {
  ...
  analyze: {
    ...
    backHome: "На главную",
    mockNote: "Ниже — демо-отчёт на mock-данных. Запустите прогон, чтобы получить живые данные.",
    launcher: {
      ...
      hhTokenLabel: "Токен HH (Bearer)",
      hhTokenPlaceholder: "Токен приложения с dev.hh.ru",
      hhTokenHint:
        "Поиск вакансий на HH API требует токен. Можно задать HH_TOKEN на сервере или вставить сюда.",
      ...
      errors: {
        ...
        hhForbidden:
          "HH API отклонил запрос (403). Нужен Bearer-токен приложения: зарегистрируйте приложение на dev.hh.ru, получите токен и укажите его в поле «Токен HH» ниже или в переменной HH_TOKEN при запуске бэкенда.",
